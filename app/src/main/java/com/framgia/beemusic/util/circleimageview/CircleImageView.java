package com.framgia.beemusic.util.circleimageview;
...
public class CircleImageView extends ImageView {
    ...
    public void setAdjustViewBounds(boolean adjustViewBounds) {
        if (!adjustViewBounds) return;
        throw new IllegalArgumentException(String.valueOf(R.string.error_bound_view));
    }
    ...
    public void setDisableCircularTransformation(boolean disableCircularTransformation) {
        if (mDisableCircularTransformation == disableCircularTransformation) return;
